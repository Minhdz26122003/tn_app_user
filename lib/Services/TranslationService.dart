...
class TranslationService extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'or': 'Or',
          'service_infor': 'Service information',
          ...
          'enter_manufacture': 'Import car brand',
          'book_6h_in_advance':
              'You need to book an appointment 6 hours in advance',
          'fullname': 'Full Name',
          ...
          'no_service': 'No services available',
          ...
          'welcome_to_GaraTech': 'Welcome to my application',
          ...
          'date': 'Date',
          'edit_car': 'Edit vehicle information',
          'login_now': 'Login ',
          'confirm': 'Confirm',
          ...
          'enter_year_manufacture': 'Enter year of manufacture',
          'name_car': 'Name car',
          'enter_name_car': 'Enter vehicle name',
          'delete_car': 'Are you sure you want to delete this vehicle?',
        ...
        'vi_VN': {
          ...
          'overview': 'Tổng quan',
          'transmitter': 'Bộ phát',
          'list_appointment': 'Danh sách lịch hẹn',
          'home': 'Trang chủ',
          ...
          'service': 'Dịch vụ',
          'book': 'Đặt lịch',
          'edit_car': 'Sửa thông tin xe',
          'edit': 'Sửa',
          'paid': 'Đã thanh toán',
          'team_use': 'Đội sử dụng',
          'processing_request': 'Đang xử lý yêu cầu',
          'price_quote': 'Báo giá',
          'accepted_quote': 'Chấp nhận báo giá',
          'repair': 'Sửa chữa',
          'completed': 'Hoàn thành',
          'settlement': 'Chốt quyết toán',
          'pay': 'Thanh toán',
          'car_list': 'Danh sách xe',
          'service_infor': 'Thông tin dịch vụ',
          'car_service': 'Dịch vụ xe',
          'service_details': 'Chi tiết dịch vụ',
          'select_service': 'Chọn dịch vụ',
          'personnel': 'Nhân viên',
          'book_6h_in_advance': 'Bạn cần đặt lịch hẹn trước 06 tiếng',
          ...
          'setting': 'Cài đặt',
          'month': 'Tháng',
          'enter_license_plate': 'Nhập biển số xe',
          'license_plate': 'Biển số xe',
          'manufacturer': 'Hãng xe',
          'year_manufacture': 'Năm sản xuất',
          'enter_manufacture': 'Nhập hãng xe',
          'enter_year_manufacture': 'Nhập năm sản xuất',
          'name_car': 'Tên xe',
          ...
          'delete_car': 'Bạn có chắc chắn muốn xóa xe này?',
          'not_updated': 'Chưa cập nhật',
          'log_out': 'Đăng xuất',
          'no_history': 'Chưa có lịch sử',
          'log_out_success': 'Đăng xuất thành công',
          'welcome_to_GaraTech': 'Chào mừng đến với ứng dụng của chúng tôi!',
          ...
          'no_service': 'Không có dịch vụ nào',
          'no_car': 'Không có xe nào',
